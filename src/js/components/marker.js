...
class MarkerObject {
    constructor(map, exact_lonlat, coordinates_lonlat, type) {
        ...
        if (type == "outboard_pleasure_boat") {
            ...
            this.div = createDivMarker(`../static/img/fishing_boat.png`, 50, 50);
            this.speed = 8;
            this.length = 20;
            this.is_boat = true;
