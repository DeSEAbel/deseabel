...
from ocean_ecosystem.utils import load_environment_config
...
# async def startup():
#     # TODO define several map per region
#     config_map = load_environment_config()["map"]
#     marine_map = MarineMap(
#         config_map["width"],
#         config_map["height"],
#         config_map["step"],
#         config_map["longitude_west"],
#         config_map["latitude_north"],
#     )
#     app.state.dict_marine_map = {"la_rochelle": marine_map}
#     app.state.simulator = {}
